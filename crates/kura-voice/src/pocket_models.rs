//! Immutable capabilities for Kura Desktop's April Pocket TTS bundle.
...
/// Capabilities of Kura Desktop's sole Pocket model.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
...
/// Return immutable metadata for Kura Desktop's April INT8 model.
