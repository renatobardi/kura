...
impl Db {
    ...
    /// request/connection error. kura-db only reads the durable host map.
    ...
    /// fully-formed [`kura_core::tenant::TenantContext`] — host included — to
    ...
    ///
    /// Used by the runtime conformance read-seam emitters in `kura-relay`:
