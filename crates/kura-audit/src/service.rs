...
const AUDIT_LOCK_NAMESPACE: &str = "kura_audit:";
...
mod tests {
    ...
    async fn test_pool() -> Option<PgPool> {
        let url = std::env::var("DATABASE_URL")
            .unwrap_or_else(|_| "postgres://kura:kura_dev@localhost:5432/kura".into()); // sadscan:disable np.postgres.1 -- local test fixture
