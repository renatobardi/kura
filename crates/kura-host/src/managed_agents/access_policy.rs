...
pub type RespondToEnv = (Vec<(&'static str, String)>, Vec<&'static str>);

/// Release packaging sets `KURA_BUILD_AGENT_ACCESS_OWNER_ONLY`; OSS/custom
/// builds do not.
pub fn owner_only_access_build() -> bool {
...
pub fn build_respond_to_env_with_policy(
    record: &ManagedAgentRecord,
