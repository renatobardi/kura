...
/// Anthropic).
pub fn runtime_metadata_env_vars<'a>(
...
pub const SESSION_TITLE_ENV_VAR: &str = "KURA_ACP_SESSION_TITLE";
/// Stable agent display name forwarded to the ACP tool surface for git
/// attribution and private-conversation provenance.
pub const DISPLAY_NAME_ENV_VAR: &str = "KURA_ACP_DISPLAY_NAME";
...
pub fn apply_agent_display_env(command: &mut std::process::Command, title: Option<String>) {
...
/// `kura-acp`.
pub fn resolve_session_title(display_name: Option<&str>, name: &str) -> Option<String> {
