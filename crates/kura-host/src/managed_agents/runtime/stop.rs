...
pub fn managed_agent_runtime_keys<T>(
...
#[cfg(test)]
pub fn managed_agent_runtime_relay_urls<T>(
    runtimes: &HashMap<ManagedAgentRuntimeKey, T>,
    pubkey: &str,
) -> Vec<String> {
...
fn stop_legacy_scalar_pid(app: &HostHandle, record: &mut ManagedAgentRecord) -> Result<(), String> {
