...
#[cfg(unix)]
pub fn sweep_orphaned_agent_processes(app: &HostHandle, skip_pids: &[u32]) {
...
#[cfg(not(unix))]
pub fn sweep_orphaned_agent_processes(app: &HostHandle, _skip_pids: &[u32]) {
    let _ = app;
}
...
#[cfg(target_os = "macos")]
pub fn sweep_system_agent_processes(instance_id: &str, skip_pids: &[u32]) {
...
#[cfg(not(unix))]
pub fn sweep_system_agent_processes(_instance_id: &str, _skip_pids: &[u32]) {}
...
/// on the next tick.
#[cfg(unix)]
pub fn sweep_system_agent_processes_with_grace(
    instance_id: &str,
    skip_pids: &[u32],
