...
pub const KNOWN_SCRIPT_INTERPRETERS: &[&str] = &["node"];
...
#[cfg(target_os = "macos")]
pub fn process_belongs_to_us(pid: u32) -> bool {
...
#[cfg(not(unix))]
pub fn process_belongs_to_us(_pid: u32) -> bool {
    false
}
...
/// identifier (`pro.oute.kura.app` for release, `pro.oute.kura.app.dev`
...
pub fn current_instance_id(app: &HostHandle) -> String {
    app.instance_id()
}
...
#[cfg(target_os = "macos")]
pub fn process_has_kura_marker(pid: u32, instance_id: &str) -> bool {
...
#[cfg(not(unix))]
pub fn process_has_kura_marker(_pid: u32, _instance_id: &str) -> bool {
    false
}
...
pub fn valid_agent_runtime_receipt(
    path: &std::path::Path,
...
pub fn valid_agent_runtime_receipt_with(
    path: &std::path::Path,
    receipt: &super::super::ManagedAgentRuntimeReceipt,
    instance_id: &str,
...
/// another start.
pub fn terminate_untracked_pair_runtime(
    app: &HostHandle,
