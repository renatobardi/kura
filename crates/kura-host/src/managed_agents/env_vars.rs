...
pub fn is_derived_provider_model_key(key: &str) -> bool {
...
pub fn display_invalid_key(key: &str) -> String {
    const MAX: usize = 64;
...
pub fn is_safe_to_reveal(key: &str) -> bool {
    const SAFE_KEYS: &[&str] = &[
        "KURA_AGENT_PROVIDER",
        "KURA_AGENT_MODEL",
