...
pub mod diff;
pub use diff::{eligible_restart_diff, RestartDiffEntry, TrackedSpawnState};
...
pub fn effective_team_instructions(
...
pub struct SpawnConfigInputs<'a> {
...
pub struct SpawnConfigSnapshot {
...
impl SpawnConfigSnapshot {
    ...
    pub fn from_inputs(inputs: SpawnConfigInputs<'_>) -> Self {
...
pub fn prospective_spawn_config_snapshot(
    record: &ManagedAgentRecord,
