...
pub fn encode_chunk_payload_png(
    json_bytes: &[u8],
    avatar_bytes: Option<&[u8]>,
) -> Result<Vec<u8>, String> {
...
pub fn extract_chunk_payload_png(png_bytes: &[u8]) -> Result<Vec<u8>, String> {
...
pub fn validate_snapshot(snapshot: &AgentSnapshot) -> Result<(), String> {
...
pub fn make_png_with_text(keyword: &str, text: &str) -> Result<Vec<u8>, String> {
    let mut buf = Vec::new();
    {
