...
fn global_config_path(app: &HostHandle) -> Result<std::path::PathBuf, String> {
...
pub fn load_global_agent_config(app: &HostHandle) -> Result<GlobalAgentConfig, String> {
...
pub fn resolve_effective_model_provider(
