...
pub struct GitBashPrerequisite {
    pub available: bool,
...
#[cfg(windows)]
pub const GIT_BASH_INSTALL_HINT: &str = INSTALL_HINT;
...
pub fn resolve_git_bash_path() -> Option<std::path::PathBuf> {
    #[cfg(windows)]
    {
...
pub fn resolve_bash_path() -> Option<std::path::PathBuf> {
    #[cfg(windows)]
    {
        let env = GitBashEnv::from_process();
        return resolve_git_bash(
...
pub fn discover_git_bash() -> Option<GitBashPrerequisite> {
    #[cfg(windows)]
    {
...
#[cfg(windows)]
pub fn git_bash_available(overrides: &std::collections::BTreeMap<String, String>) -> bool {
...
pub fn resolve_git_bash_no_registry(
    path_env: &str,
    shell_override: Option<PathBuf>,
    git_bash_override: Option<PathBuf>,
    system_root: Option<PathBuf>,
