#![deny(unsafe_code)]
#![warn(missing_docs)]
//! Kura search — community-scoped Postgres full-text search over Kura events.
//!
...
//! by `kura-db`. The relay refetches canonical events through `kura-db`'s
