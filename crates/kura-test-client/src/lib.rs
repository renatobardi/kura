...
//! Minimal NIP-01 WebSocket test client for the Kura relay.
...
use kura_ws_client::NostrWsConnection;
pub use kura_ws_client::{parse_relay_message, OkResponse, RelayMessage, WsClientError};

/// Errors returned by [`KuraTestClient`] operations.
#[derive(Debug, Error)]
...
/// WebSocket test client for integration testing against a running Kura relay.
pub struct KuraTestClient {
