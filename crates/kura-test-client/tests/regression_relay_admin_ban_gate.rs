...
//! (KURA-SEC-007 class, reported 2026-07-27).
//!
...
//!   DATABASE_URL=postgres://kura:kura_dev@localhost:5432/kura_relay_admin_regression \
//!   cargo test -p kura-test-client --test regression_relay_admin_ban_gate \
//!     -- --ignored --nocapture
