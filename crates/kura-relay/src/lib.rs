#![deny(unsafe_code)]
#![warn(missing_docs)]
//! NIP-01 WebSocket relay for Kura private team communication.
...
/// `docs/spec/MultiTenantRelay.tla` by the independent `kura-conformance`
/// checker.
pub mod conformance;
...
/// Inter-relay mesh startup wiring (`KURA_MESH` seam).
pub mod mesh_boot;
...
/// Workflow action sink — relay-side implementation of [`kura_workflow::ActionSink`].
