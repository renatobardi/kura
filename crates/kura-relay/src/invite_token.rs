...
//! `key = sha256(relay_secret_key_bytes || "kura-invite-v1")`. Rotating the
...
pub use kura_core::invite::DEFAULT_INVITE_TTL_SECS;

/// Maximum invite lifetime a mint request may ask for: 30 days.
pub use kura_core::invite::MAX_INVITE_TTL_SECS;
...
const KEY_DERIVATION_LABEL: &[u8] = b"kura-invite-v1";
