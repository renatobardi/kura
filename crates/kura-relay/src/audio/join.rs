...
//! [`MeshStreamFrame::Data`](kura_relay_mesh::MeshStreamFrame). Their layout is
...
/// [`MeshStreamFrame::Data`](kura_relay_mesh::MeshStreamFrame)`.payload`,
...
mod tests {
    ...
    use kura_relay_mesh::{BoxFuture, StreamRecvHalf, StreamSendHalf};
    ...
    impl RelayPeerTransport for NullTransport {
        ...
        fn set_inbound(&self, _handler: Box<dyn kura_relay_mesh::InboundHandler>) {}
    }
