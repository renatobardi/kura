...
//!
//! Crash report (2026-07-08, kura-desktop 0.3.46): enabling Share compute
...
//!
//!   cargo run -p kura-relay --example mesh_stack_smoke
...
/// Must match `kura_lib::mesh_llm::MESH_WORKER_STACK_SIZE` (desktop crate is
/// not a dependency of kura-relay, so the value is duplicated here).
