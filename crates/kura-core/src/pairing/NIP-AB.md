...
```bash
tamarin-prover --prove crates/kura-core/src/pairing/NIP-AB.spthy
```
...
Implementations MUST validate against these vectors. They can be reproduced with `kura-pair test-vectors`.
