...
pub const FORMAT: &str = "kura-private-managed-agent";
...
mod tests {
    ...
    fn projection_hash_fixture_is_stable() {
        assert_eq!(
            content_sha256(b"kura-private-managed-agent-v1"),
            "4cafba499655e335a8f4d3b29d3a82fde1837863bb1c23c957d7d8d5ce79ad10"
        );
    }
}
