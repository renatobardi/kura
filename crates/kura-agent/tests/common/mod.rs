//! Shared subprocess test harness for the kura-agent ACP integration suites.
//!
...
//!
//! It drives a real `kura-agent` child over the ACP wire against a fake LLM
...
/// `session/request_permission` response. Mirrors kura-acp's answering side,
