...
//!
//! kura-agent asks the client to authorize every LLM-issued MCP tool call
//! *before* executing it; the client applies `KURA_ACP_PERMISSION_POLICY` and
...
//!   (`KURA_AGENT_MAX_PENDING_PERMISSIONS`) acquired *before* any correlation
