...
///   `str_ends_with`, `str_len` (duplicated intentionally from kura-workflow).
...
/// `str_len` — duplicated from kura-workflow intentionally so this crate
/// has no runtime dependency on kura-workflow.
