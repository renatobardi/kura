...
pub async fn dispatch(cmd: crate::UploadCmd, client: &KuraClient) -> Result<(), CliError> {
    match cmd {
...
pub async fn dispatch_media(cmd: crate::MediaCmd, client: &KuraClient) -> Result<(), CliError> {
    match cmd {
