...
pub fn sdk_err(e: kura_sdk::SdkError) -> CliError {
    match e {
        kura_sdk::SdkError::InvalidInput(msg) => CliError::Usage(msg),
...
mod tests {
    ...
    // and `normalize_mention_pubkeys` live in `kura_sdk::mentions` and are tested there.
