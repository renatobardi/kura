//! Owner-reviewed agent draft requests published through Kura observer frames.

use kura_core::observer::{encrypt_observer_payload, OBSERVER_FRAME_TELEMETRY};
...
fn build<T: Serialize>(
    ...
    let event = kura_sdk::build_agent_observer_frame(
        &owner.to_hex(),
...
mod tests {
    use super::*;
    use kura_core::observer::{decrypt_observer_payload, OBSERVER_AGENT_TAG, OBSERVER_FRAME_TAG};
