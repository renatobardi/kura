#![deny(unsafe_code)]
#![warn(missing_docs)]
//! `kura-sdk` — typed Nostr event builders for Kura operations.
//!
//! # Mental Model
//!
//! ```text
...
/// Re-export kind constants so consumers don't need kura-core directly.
pub use kura_core::kind;
...
pub use kura_core::channel::canonical_channel_name;
/// Channel type.
pub use kura_core::channel::ChannelType as ChannelKind;
/// Channel visibility.
pub use kura_core::channel::ChannelVisibility as Visibility;
/// Member role.
