"""Harbor custom-agent entry point for Kura orchestration."""
...
from .container_runtime import KuraContainerRuntime, EndpointLaunchConfig
from .manifest import ExperimentManifest
from .provisioning import TrialProvisioner
from .runtime import OrchestraRuntime


class KuraOrchestraAgent(BaseAgent):
    """Coordinate an arbitrary manifest-defined team through a Kura trial."""
    ...
    def _build_runtime(
        ...
        kura_acp_binary: str,
        kura_agent_binary: str,
        kura_dev_mcp_binary: str,
        kura_cli_binary: str,
        relay_gateway: str,
        ...
        return KuraContainerRuntime(
            ...
            endpoints=endpoints,
            kura_acp_binary=kura_acp_binary,
            kura_agent_binary=kura_agent_binary,
            kura_dev_mcp_binary=kura_dev_mcp_binary,
            kura_cli_binary=kura_cli_binary,
    ...
    async def run(
        ...
        if self.provisioner is None or self.runtime is None:
            raise RuntimeError(
                "KuraOrchestraAgent requires provisioner and runtime integrations; "
        ...
        context.metadata = {
            **result.metadata,
            ...
            "kura_channel_id": handle.channel_id,
            "run_id": run_id,
            "trial_id": trial_id,
        }
