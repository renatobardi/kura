"""Typed boundary between the Harbor adapter and Kura trial provisioning."""
...
class AgentCredential:
    """One trial-scoped Kura identity and attributed LLM credential."""
...
class DirectoryIdentity:
    """One public, benchmark-seeded identity discoverable through Kura."""
...
@dataclass(frozen=True, slots=True)
class TrialHandle:
    """Provisioned Kura resources owned by one Harbor trial."""
    ...
    user_relay_url: str = ""
    # Additive Kura-native task context. Directory entries contain no secrets.
    task_name: str = ""
...
class TrialProvisioner(Protocol):
    """Creates and tears down trial-isolated Kura resources synchronously."""
