...
function RepositoryUnavailableIndicator({
  ...
  const status = {
    authentication: {
      description: "Kura could not authenticate with this repository.",
      label: "Access failed",
    },
    missing: {
      description: "No git repository was found on the Kura relay.",
      label: "Uninitialized",
    },
    access: {
      description:
    ...
    network: {
      description: "The Kura git service could not be reached.",
      label: "Unreachable",
    },
    ref: {
    ...
    unknown: {
      description: "Kura could not load this repository.",
      label: "Unavailable",
    },
  } satisfies Record<
