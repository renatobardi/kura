...
export const WELCOME_GUIDE_AGENT_NAME = "Hayate";
export const WELCOME_GUIDE_PERSONA_ID = "builtin:hayate";
export const WELCOME_TEAM_ID = "builtin-team:welcome";
export const WELCOME_GUIDE_INTRO_MARKER = "kura-welcome-intro.v1";
...
export const WELCOME_GUIDE_INTRO_MESSAGE =
  "Hi, I'm Hayate. Welcome to Kura.\n\nI can help you get oriented, answer questions, and make the first few steps feel less mysterious.\n\nFeel free to ask me what else you can do in Kura, or just talk through what you want to build.";
