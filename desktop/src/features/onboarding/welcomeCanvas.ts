...
export const WELCOME_CANVAS_CONTENT = `# Welcome to Kura

This private channel is your home base for getting oriented. Hayate, Kaede, and Rin can help you learn the app, troubleshoot setup, and work through something you are building.
...
Ask the team a question here, or read the [Kura user guide](https://github.com/renatobardi/kura#readme).
`;
