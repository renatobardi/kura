...
export function AvatarFramingSlider({
  ...
  const sliderControl = (
    <div className="kura-avatar-framing-slider-wrapper">
      <div
        ...
        className={cn(
          "kura-avatar-framing-slider",
          compact && "kura-avatar-framing-slider--compact",
        )}
        ...
        style={
          {
            "--kura-avatar-framing-slider-fill": `${fill}%`,
          } as React.CSSProperties
        }
        tabIndex={disabled ? -1 : 0}
      >
        <div className="kura-avatar-framing-slider-hashmarks">
          {ticks.map((tick) => (
            <span
              aria-hidden="true"
              className="kura-avatar-framing-slider-hashmark"
              key={tick}
              style={{
        ...
        <div aria-hidden="true" className="kura-avatar-framing-slider-fill" />
        <div aria-hidden="true" className="kura-avatar-framing-slider-handle" />
      </div>
      <button
      ...
      {tipText ? (
        <p
          className="kura-avatar-framing-slider-tip"
