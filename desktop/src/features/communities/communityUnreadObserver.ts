...
const participationStore = makeRootIdStore("kura-thread-participation.v1");
const authoredStore = makeRootIdStore("kura-thread-authored.v1");
const mutedRootsStore = makeRootIdStore("kura-thread-muted.v1");
const FOLLOWS_STORAGE_KEY_PREFIX = "kura-thread-follows.v1";
