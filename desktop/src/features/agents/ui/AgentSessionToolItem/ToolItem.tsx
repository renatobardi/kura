...
import { getKuraToolInfo } from "../agentSessionToolCatalog";
...
export function ToolItem({
  ...
  const canonicalToolName = item.kuraToolName ?? item.toolName;
  const kuraTool = getKuraToolInfo(canonicalToolName);
