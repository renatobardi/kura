...
mod tests {
    ...
    fn serialization_round_trip() {
        ...
        let original = ChannelTemplateRecord {
            ...
            agents: TemplateAgentRoster {
                personas: vec![TemplateAgentEntry {
                    persona_id: "builtin:hayate".to_string(),
        ...
        assert_eq!(parsed.agents.personas[0].persona_id, "builtin:hayate");
    ...
    fn deserialization_backward_compat_provider_alias() {
        ...
        let agent_json = r#"{"personaId":"builtin:hayate","provider":"goose"}"#;
