...
Next to it, a "Connect on Kura" button.
...
You hit "Connect on Kura" and the app opens. You're in `#general`. The team is
...
"Connect on Kura" and they're in the community. No separate onboarding flow. No
...
portable even when the hosting isn't. And you can use Kura as a collaboration
layer on top of GitHub if that's what makes sense — work in Kura channels, push
...
Someone picks up the bug. They create a branch. Kura creates a channel:
...
things are announcements. Some things are essays. Kura has surfaces for both,
...
Onboarding friction is real — not insurmountable, but real. The "Connect on Kura"
