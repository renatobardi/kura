...
# Installed Kura state is preserved.
# =============================================================================
set -euo pipefail
...
if [[ "${1:-}" != "--yes" ]]; then
  ...
  echo -e "   Installed Kura app state and its production keyring are preserved."
...
success "Desktop development state removed (installed Kura state preserved)"
